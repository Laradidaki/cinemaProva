...
public class Film {
	 ...
	 */
	public Integer getDurataFilm() {
		return durataFilm;
	}
	/**
	 * @param durataFilm the durataFilm to set
	 */
	public void setDurataFilm(Integer durataFilm) {
	 ...
	 */
	public Integer getCostoFilm() {
		return costoFilm;
	}
	/**
	 * @param costoFilm the costoFilm to set
	 */
	public void setCostoFilm(Integer costoFilm) {
