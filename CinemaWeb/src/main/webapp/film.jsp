...
<body>
 <form method="POST" action='MovieController' name="frmAddFilm">
        Film ID : <input type="text" readonly="readonly" name="idFilm"
            value="<c:out value="${film.idFilm}" />" /> <br /> 
        Nome Film : <input
            type="text" name="nomeFilm"
            value="<c:out value="${film.nomeFilm}" />" /> <br /> 
        Durata Film : <input
            type="text" name="durataFilm"
            value="<c:out value="${film.durataFilm}" />" /> <br /> 
        Anno Film : <input type="text" name="annoFilm"
            value="<c:out value="${film.annoFilm}" />" /> <br /> 
        Costo Film : <input
            type="text" name="costoFilm"
