...
<body>
 <form method="POST" action='AttoreController' name="frmAddAttore">
        Attore ID : <input type="text" readonly="readonly" name="idAttore"
            value="<c:out value="${attore.idAttore}" />" /> <br /> 
        Nome Attore : <input
            type="text" name="nomeAttore"
            value="<c:out value="${attore.nomeAttore}" />" /> <br /> 
        Cognome Attore : <input
            type="text" name="cognomeAttore"
